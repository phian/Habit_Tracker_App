    ...
    return Stack(
      children: [
        _cloudIcon(
          ...
          iconSize: 65.0,
          transformTop: -MediaQuery.of(context).size.height * 0.09,
        ),
        _cloudIcon(
          marginTop: 10.0,
          marginLeft: MediaQuery.of(context).size.width * 0.8,
          iconSize: 45.0,
          transformTop: -MediaQuery.of(context).size.height * 0.065,
        ),
        _cloudIcon(
        ...
        _cloudIcon(
            ...
            marginLeft: MediaQuery.of(context).size.width * 0.18,
            iconSize: 30.0,
